"""
BCS Stage 1 Capability Test 012: Field: Uniform Repeated Byte
Description: Ensure u and Phi converge to stable, low variance fields on uniform input
...
def run_test():
    print("Running capability test 012: Field: Uniform Repeated Byte")
    ...
    metrics = {
        "test_id": 12,
        "test_name": "Field: Uniform Repeated Byte",
        "description": "Ensure u and Phi converge to stable, low variance fields on uniform input",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_012.json"
