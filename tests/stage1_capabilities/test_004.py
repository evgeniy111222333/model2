"""
BCS Stage 1 Capability Test 004: Modality: JSON Structural Brackets
Description: Verify modality detection on structural JSON code with brackets and colons
...
def run_test():
    print("Running capability test 004: Modality: JSON Structural Brackets")
    
    # 1. Generate Input Data
    data = b'{"menu": {"id": "file", "value": "File", "popup": {"menuitem": [{"value": "New", "onclick": "CreateNewDoc()"}]}}}' * 3
    ...
    metrics = {
        "test_id": 4,
        "test_name": "Modality: JSON Structural Brackets",
        "description": "Verify modality detection on structural JSON code with brackets and colons",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_004.json"
