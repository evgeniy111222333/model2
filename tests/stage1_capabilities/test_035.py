"""
BCS Stage 1 Capability Test 035: Boundary: HTML Code Layout Boundaries
Description: Verify boundaries align with syntactic tags inside markup streams
...
def run_test():
    print("Running capability test 035: Boundary: HTML Code Layout Boundaries")
    
    # 1. Generate Input Data
    data = b'<html><body>' + b'A'*80 + b'</body></html>'
    ...
    metrics = {
        "test_id": 35,
        "test_name": "Boundary: HTML Code Layout Boundaries",
        "description": "Verify boundaries align with syntactic tags inside markup streams",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_035.json"
