"""
BCS Stage 1 Capability Test 091: Optim: Fisher Information Matrix trace
Description: Check that Fisher Information Matrix calculates positive and finite traces
...
def run_test():
    print("Running capability test 091: Optim: Fisher Information Matrix trace")
    
    # 1. Generate Input Data
    data = b'ABCDEFGH' * 50
    
    # 2. Initialize Model
    # Config parameters: {'use_fisher_geometry': True, 'n_active_bytes': 32}
    model = create_model(**{'use_fisher_geometry': True, 'n_active_bytes': 32})
    ...
    metrics = {
        "test_id": 91,
        "test_name": "Optim: Fisher Information Matrix trace",
        "description": "Check that Fisher Information Matrix calculates positive and finite traces",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_091.json"
