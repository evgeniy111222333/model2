"""
BCS Stage 1 Capability Test 036: Boundary: CSV File layout
Description: Check boundary markers on tabular numerical records separated by newlines
...
def run_test():
    print("Running capability test 036: Boundary: CSV File layout")
    ...
    metrics = {
        "test_id": 36,
        "test_name": "Boundary: CSV File layout",
        "description": "Check boundary markers on tabular numerical records separated by newlines",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_036.json"
