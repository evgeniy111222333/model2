"""
BCS Stage 1 Capability Test 024: Predictive: Context Size Sweep
Description: Verify convergence when prediction error loop is active with standard context
...
def run_test():
    print("Running capability test 024: Predictive: Context Size Sweep")
    ...
    metrics = {
        "test_id": 24,
        "test_name": "Predictive: Context Size Sweep",
        "description": "Verify convergence when prediction error loop is active with standard context",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_024.json"
