"""
BCS Stage 1 Capability Test 062: IB: Optimal Beta sweep
Description: Ensure optimal beta parameter selection correctly trades compression for prediction
...
def run_test():
    print("Running capability test 062: IB: Optimal Beta sweep")
    ...
    metrics = {
        "test_id": 62,
        "test_name": "IB: Optimal Beta sweep",
        "description": "Ensure optimal beta parameter selection correctly trades compression for prediction",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_062.json"
