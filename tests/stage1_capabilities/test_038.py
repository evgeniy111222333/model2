"""
BCS Stage 1 Capability Test 038: Boundary: Detector Scale Sensitivity
Description: Verify boundary detection performs correctly on standard scale parameters
...
def run_test():
    print("Running capability test 038: Boundary: Detector Scale Sensitivity")
    ...
    metrics = {
        "test_id": 38,
        "test_name": "Boundary: Detector Scale Sensitivity",
        "description": "Verify boundary detection performs correctly on standard scale parameters",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_038.json"
