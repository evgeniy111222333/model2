"""
BCS Stage 1 Capability Test 001: Modality: Plain Text ASCII (English)
Description: Check if English ASCII plaintext is detected with high confidence as text_ascii
...
def run_test():
    print("Running capability test 001: Modality: Plain Text ASCII (English)")
    
    # 1. Generate Input Data
    data = b'The quick brown fox jumps over the lazy dog. Scientific and mathematical notations are useful.' * 5
    ...
    metrics = {
        "test_id": 1,
        "test_name": "Modality: Plain Text ASCII (English)",
        "description": "Check if English ASCII plaintext is detected with high confidence as text_ascii",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_001.json"
