"""
BCS Stage 1 Capability Test 028: Predictive: Field Correction Rate Sensitivity
Description: Examine field dynamics adjustment magnitude under prediction feedback loop
...
def run_test():
    print("Running capability test 028: Predictive: Field Correction Rate Sensitivity")
    ...
    metrics = {
        "test_id": 28,
        "test_name": "Predictive: Field Correction Rate Sensitivity",
        "description": "Examine field dynamics adjustment magnitude under prediction feedback loop",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_028.json"
