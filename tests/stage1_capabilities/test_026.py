"""
BCS Stage 1 Capability Test 026: Predictive: Anomaly Byte Insertion
Description: Check prediction error response under stream expansion anomaly
...
def run_test():
    print("Running capability test 026: Predictive: Anomaly Byte Insertion")
    
    # 1. Generate Input Data
    data = b'ABCDEFGH' * 20 + b'XY' + b'ABCDEFGH' * 20
    ...
    metrics = {
        "test_id": 26,
        "test_name": "Predictive: Anomaly Byte Insertion",
        "description": "Check prediction error response under stream expansion anomaly",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_026.json"
