"""
BCS Stage 1 Capability Test 092: Optim: Fisher Matrix Condition Number
Description: Verify that the condition number is stable and finite
...
def run_test():
    print("Running capability test 092: Optim: Fisher Matrix Condition Number")
    ...
    metrics = {
        "test_id": 92,
        "test_name": "Optim: Fisher Matrix Condition Number",
        "description": "Verify that the condition number is stable and finite",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_092.json"
