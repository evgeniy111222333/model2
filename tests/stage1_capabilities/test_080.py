"""
BCS Stage 1 Capability Test 080: Memory: Forgetting step validation
Description: Verify forgetting steps remove weak crystallized traces
...
def run_test():
    print("Running capability test 080: Memory: Forgetting step validation")
    ...
    metrics = {
        "test_id": 80,
        "test_name": "Memory: Forgetting step validation",
        "description": "Verify forgetting steps remove weak crystallized traces",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_080.json"
