"""
BCS Stage 1 Capability Test 032: Boundary: Multiple Sequential Transitions
Description: Examine section boundary coordinates for multiple contiguous patterns
...
def run_test():
    print("Running capability test 032: Boundary: Multiple Sequential Transitions")
    ...
    metrics = {
        "test_id": 32,
        "test_name": "Boundary: Multiple Sequential Transitions",
        "description": "Examine section boundary coordinates for multiple contiguous patterns",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_032.json"
