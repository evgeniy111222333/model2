"""
BCS Stage 1 Capability Test 061: IB: Objective Value Computation
Description: Verify that mutual information bottleneck objective computes finite metrics
...
def run_test():
    print("Running capability test 061: IB: Objective Value Computation")
    ...
    metrics = {
        "test_id": 61,
        "test_name": "IB: Objective Value Computation",
        "description": "Verify that mutual information bottleneck objective computes finite metrics",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_061.json"
