"""
BCS Stage 1 Capability Test 047: Clustering: Temperature Scale Effect
Description: Check clustering behaviour when running at customized temperature scaling
...
def run_test():
    print("Running capability test 047: Clustering: Temperature Scale Effect")
    ...
    metrics = {
        "test_id": 47,
        "test_name": "Clustering: Temperature Scale Effect",
        "description": "Check clustering behaviour when running at customized temperature scaling",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_047.json"
