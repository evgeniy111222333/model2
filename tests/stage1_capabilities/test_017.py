"""
BCS Stage 1 Capability Test 017: Field: Diffusion constant D_v Sensitivity
Description: Analyze system stability under low D_v diffusion constants
...
def run_test():
    print("Running capability test 017: Field: Diffusion constant D_v Sensitivity")
    
    # 1. Generate Input Data
    data = b'ABCDEFGH' * 50
    
    # 2. Initialize Model
    # Config parameters: {'D_v': 0.01, 'n_active_bytes': 32}
    model = create_model(**{'D_v': 0.01, 'n_active_bytes': 32})
    ...
    metrics = {
        "test_id": 17,
        "test_name": "Field: Diffusion constant D_v Sensitivity",
        "description": "Analyze system stability under low D_v diffusion constants",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_017.json"
