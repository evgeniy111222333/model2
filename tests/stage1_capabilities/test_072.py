"""
BCS Stage 1 Capability Test 072: Memory: Novelty Score Calculation
Description: Check that novelty score is computed for working memory insertions
...
def run_test():
    print("Running capability test 072: Memory: Novelty Score Calculation")
    ...
    metrics = {
        "test_id": 72,
        "test_name": "Memory: Novelty Score Calculation",
        "description": "Check that novelty score is computed for working memory insertions",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_072.json"
