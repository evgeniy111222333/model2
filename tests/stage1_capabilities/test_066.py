"""
BCS Stage 1 Capability Test 066: IB: GNN vs Default Conversion comparison
Description: Verify representation features under GNN conversion
...
def run_test():
    print("Running capability test 066: IB: GNN vs Default Conversion comparison")
    
    # 1. Generate Input Data
    data = b'ABCDEFGH' * 50
    
    # 2. Initialize Model
    # Config parameters: {'use_gnn_conversion': True, 'n_active_bytes': 32}
    model = create_model(**{'use_gnn_conversion': True, 'n_active_bytes': 32})
    ...
    metrics = {
        "test_id": 66,
        "test_name": "IB: GNN vs Default Conversion comparison",
        "description": "Verify representation features under GNN conversion",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_066.json"
