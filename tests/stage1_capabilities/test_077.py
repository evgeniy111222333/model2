"""
BCS Stage 1 Capability Test 077: Memory: Crystallized Decay rate
Description: Check decay rate parameters of the crystallized memory bank
...
def run_test():
    print("Running capability test 077: Memory: Crystallized Decay rate")
    ...
    metrics = {
        "test_id": 77,
        "test_name": "Memory: Crystallized Decay rate",
        "description": "Check decay rate parameters of the crystallized memory bank",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_077.json"
