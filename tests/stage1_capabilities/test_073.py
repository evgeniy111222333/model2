"""
BCS Stage 1 Capability Test 073: Memory: Working Memory Key Recall
Description: Verify recall retrieval correctness from short-term working memory cache
...
def run_test():
    print("Running capability test 073: Memory: Working Memory Key Recall")
    ...
    metrics = {
        "test_id": 73,
        "test_name": "Memory: Working Memory Key Recall",
        "description": "Verify recall retrieval correctness from short-term working memory cache",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_073.json"
