"""
BCS Stage 1 Capability Test 088: Resonance: Feedback Loop Stability
Description: Ensure field stays stable over long iterations under context injection
...
def run_test():
    print("Running capability test 088: Resonance: Feedback Loop Stability")
    ...
    metrics = {
        "test_id": 88,
        "test_name": "Resonance: Feedback Loop Stability",
        "description": "Ensure field stays stable over long iterations under context injection",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_088.json"
