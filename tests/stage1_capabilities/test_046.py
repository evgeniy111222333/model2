"""
BCS Stage 1 Capability Test 046: Clustering: Pattern Group Consistency
Description: Ensure identical patterns separated by noise are assigned same pattern group
...
def run_test():
    print("Running capability test 046: Clustering: Pattern Group Consistency")
    
    # 1. Generate Input Data
    data = b'XYZW'*20 + b'M'*100 + b'XYZW'*20
    ...
    metrics = {
        "test_id": 46,
        "test_name": "Clustering: Pattern Group Consistency",
        "description": "Ensure identical patterns separated by noise are assigned same pattern group",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_046.json"
