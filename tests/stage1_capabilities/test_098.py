"""
BCS Stage 1 Capability Test 098: Optim: CMA-ES Parameter calibration landscape
Description: Check that CMA-ES updates optimize field parameters correctly
...
def run_test():
    print("Running capability test 098: Optim: CMA-ES Parameter calibration landscape")
    ...
    metrics = {
        "test_id": 98,
        "test_name": "Optim: CMA-ES Parameter calibration landscape",
        "description": "Check that CMA-ES updates optimize field parameters correctly",
        "success": False
    }
    ...
    out_path = f"test_results/cap_test_098.json"
